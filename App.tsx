...
const App = () => (
  <SafeAreaView style={styles.container}>
    <View>
      ...
      Recomenda-se definir accessibilityLabel para ajudar a tornnar seu aplicativo utilizável para todos.
      </Text>
        <Button
        title="Aperte Aqui"
    ...
    <View>
      <Text style={styles.title}>
      Ajuste a cor de uma forma que pareça padrão em cada plataforma.
